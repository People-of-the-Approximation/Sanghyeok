...
# =========================================================
# [수정] 절대 경로를 사용하여 무조건 폴더를 찾게 만드는 코드
# =========================================================

# 1. 현재 실행 중인 app.py 파일의 절대 경로를 구합니다.
BASE_DIR = os.path.dirname(os.path.abspath(__file__))

# 2. app.py가 있는 곳의 static 폴더 경로를 생성합니다.
STATIC_DIR = os.path.join(BASE_DIR, "static")

# 3. 디버깅용: 터미널에 실제 경로를 출력해봅니다. (문제 해결 확인용)
print(f"Checking Static Directory at: {STATIC_DIR}")

# 4. directory에 단순히 "static"이 아니라, 위에서 만든 'STATIC_DIR'을 넣어줍니다.
app.mount("/static", StaticFiles(directory=STATIC_DIR), name="static")
# =========================================================

# static 폴더 서빙 (CSS/이미지)
app.mount(
    "/00_Softmax_Approx_with_Tree/04_Python_Code/02_pycode_final_sangyun/static",
